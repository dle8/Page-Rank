...
public class PageRank {
	...
	public static void main(String[] args) throws Exception {
		...
		graphLink = "/user/page-rank/run4/GraphLink";
		wikiCount = "/user/page-rank/run4/WikiCount";
		pageRankInitializer = "/user/page-rank/run4/PageRankInitializer";
		pageRankAlgo = "/user/page-rank/run4/PageRankAlgo";
